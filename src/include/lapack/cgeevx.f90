pure subroutine cgeevx(balanc,jobvl,jobvr,sense,n,a,lda,w,vl,ldvl,vr,ldvr,ilo,ihi,scale,abnrm,rconde,rcondv,work,lwork,rwork,info) BEGCNAME(cgeevx,SUFFIX)
ENDCNAME(cgeevx,SUFFIX)
import
