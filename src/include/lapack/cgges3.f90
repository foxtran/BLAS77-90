pure subroutine cgges3(jobvsl,jobvsr,sort,selctg,n,a,lda,b,ldb,sdim,alpha,beta,vsl,ldvsl,vsr,ldvsr,work,lwork,rwork,bwork,info) BEGCNAME(cgges3,SUFFIX)
ENDCNAME(cgges3,SUFFIX)
import
