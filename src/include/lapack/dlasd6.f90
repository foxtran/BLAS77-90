pure subroutine dlasd6(icompq,nl,nr,sqre,d,vf,vl,alpha,beta,idxq,perm,givptr,givcol,ldgcol,givnum,ldgnum,poles,difl,difr,z,k,c,s,work,iwork,info) BEGCNAME(dlasd6,SUFFIX)
ENDCNAME(dlasd6,SUFFIX)
import
