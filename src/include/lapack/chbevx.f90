pure subroutine chbevx(jobz,range,uplo,n,kd,ab,ldab,q,ldq,vl,vu,il,iu,abstol,m,w,z,ldz,work,rwork,iwork,ifail,info) BEGCNAME(chbevx,SUFFIX)
ENDCNAME(chbevx,SUFFIX)
import
