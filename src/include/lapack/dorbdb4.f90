pure subroutine dorbdb4(m,p,q,x11,ldx11,x21,ldx21,theta,phi,taup1,taup2,tauq1,phantom,work,lwork,info) BEGCNAME(dorbdb4,SUFFIX)
ENDCNAME(dorbdb4,SUFFIX)
import
...
real(blas77_f64), intent(inout) :: phantom(*)
