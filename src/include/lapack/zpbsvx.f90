pure subroutine zpbsvx(fact,uplo,n,kd,nrhs,ab,ldab,afb,ldafb,equed,s,b,ldb,x,ldx,rcond,ferr,berr,work,rwork,info) BEGCNAME(zpbsvx,SUFFIX)
ENDCNAME(zpbsvx,SUFFIX)
import
