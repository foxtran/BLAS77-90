pure subroutine slaebz(ijob,nitmax,n,mmax,minp,nbmin,abstol,reltol,pivmin,d,e,e2,nval,ab,c,mout,nab,work,iwork,info) BEGCNAME(slaebz,SUFFIX)
ENDCNAME(slaebz,SUFFIX)
import
