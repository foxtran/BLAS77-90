pure subroutine dlals0(icompq,nl,nr,sqre,nrhs,b,ldb,bx,ldbx,perm,givptr,givcol, &
    ldgcol,givnum,ldgnum,poles,difl,difr,z,k,c,s,work, &
    info) BEGCNAME(dlals0,SUFFIX)
