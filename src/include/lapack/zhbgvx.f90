pure subroutine zhbgvx(jobz,range,uplo,n,ka,kb,ab,ldab,bb,ldbb,q,ldq,vl,vu,il,iu,abstol,m,w,z,ldz,work,rwork,iwork,ifail,info) BEGCNAME(zhbgvx,SUFFIX)
ENDCNAME(zhbgvx,SUFFIX)
import
