pure subroutine zla_gerfsx_extended(prec_type,trans_type,n,nrhs,a,lda,af,ldaf, &
    ipiv,colequ,c,b,ldb,y,ldy,berr_out,n_norms,errs_n,errs_c,res,ayb,dy,y_tail, &
    rcond,ithresh,rthresh,dz_ub,ignore_cwise, &
    info) BEGCNAME(zla_gerfsx_extended,SUFFIX)
