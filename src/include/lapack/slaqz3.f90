pure subroutine slaqz3(ilschur,ilq,ilz,n,ilo,ihi,nw,a,lda,b,ldb,q,ldq,z,ldz,ns,nd,alphar,alphai,beta,qc,ldqc,zc,ldzc,work,lwork,rec,info) BEGCNAME(slaqz3,SUFFIX)
ENDCNAME(slaqz3,SUFFIX)
import
