pure subroutine dlaqz0(wants,wantq,wantz,n,ilo,ihi,a,lda,b,ldb,alphar,alphai,beta,q,ldq,z,ldz,work,lwork,rec,info) BEGCNAME(dlaqz0,SUFFIX)
ENDCNAME(dlaqz0,SUFFIX)
import
