pure subroutine dposvx(fact,uplo,n,nrhs,a,lda,af,ldaf,equed,s,b,ldb,x,ldx,rcond,ferr,berr,work,iwork,info) BEGCNAME(dposvx,SUFFIX)
ENDCNAME(dposvx,SUFFIX)
import
