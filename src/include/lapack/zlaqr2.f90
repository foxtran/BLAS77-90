pure subroutine zlaqr2(wantt,wantz,n,ktop,kbot,nw,h,ldh,iloz,ihiz,z,ldz,ns,nd,sh,v,ldv,nh,t,ldt,nv,wv,ldwv,work,lwork) BEGCNAME(zlaqr2,SUFFIX)
ENDCNAME(zlaqr2,SUFFIX)
import
