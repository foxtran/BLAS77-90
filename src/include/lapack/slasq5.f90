pure subroutine slasq5(i0,n0,z,pp,tau,sigma,dmin,dmin1,dmin2,dn,dnm1,dnm2,ieee,eps) BEGCNAME(slasq5,SUFFIX)
ENDCNAME(slasq5,SUFFIX)
import
...
real(blas77_f32), intent(inout) :: dnm1
real(blas77_f32), intent(inout) :: dnm2
