pure subroutine cgesvx(fact,trans,n,nrhs,a,lda,af,ldaf,ipiv,equed,r,c,b,ldb,x,ldx,rcond,ferr,berr,work,rwork,info) BEGCNAME(cgesvx,SUFFIX)
ENDCNAME(cgesvx,SUFFIX)
import
