pure subroutine ssytrd_sb2st(stage1,vect,uplo,n,kd,ab,ldab,d,e,hous,lhous,work,lwork,info) BEGCNAME(ssytrd_sb2st,SUFFIX)
ENDCNAME(ssytrd_sb2st,SUFFIX)
import
...
real(blas77_f32), intent(inout) :: hous(*)
