pure subroutine ztgsja(jobu,jobv,jobq,m,p,n,k,l,a,lda,b,ldb,tola,tolb,alpha,beta,u,ldu,v,ldv,q,ldq,work,ncycle,info) BEGCNAME(ztgsja,SUFFIX)
ENDCNAME(ztgsja,SUFFIX)
import
