pure subroutine sorbdb4(m,p,q,x11,ldx11,x21,ldx21,theta,phi,taup1,taup2,tauq1,phantom,work,lwork,info) BEGCNAME(sorbdb4,SUFFIX)
ENDCNAME(sorbdb4,SUFFIX)
import
...
real(blas77_f32), intent(inout) :: phantom(*)
