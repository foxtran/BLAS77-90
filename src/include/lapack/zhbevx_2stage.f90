pure subroutine zhbevx_2stage(jobz,range,uplo,n,kd,ab,ldab,q,ldq,vl,vu,il,iu,abstol,m,w,z,ldz,work,lwork,rwork,iwork,ifail,info) BEGCNAME(zhbevx_2stage,SUFFIX)
ENDCNAME(zhbevx_2stage,SUFFIX)
import
