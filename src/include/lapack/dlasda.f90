pure subroutine dlasda(icompq,smlsiz,n,sqre,d,e,u,ldu,vt,k,difl,difr,z,poles, &
    givptr,givcol,ldgcol,perm,givnum,c,s,work,iwork, &
    info) BEGCNAME(dlasda,SUFFIX)
