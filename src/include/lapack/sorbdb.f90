pure subroutine sorbdb(trans,signs,m,p,q,x11,ldx11,x12,ldx12,x21,ldx21,x22,ldx22,theta,phi,taup1,taup2,tauq1,tauq2,work,lwork,info) BEGCNAME(sorbdb,SUFFIX)
ENDCNAME(sorbdb,SUFFIX)
import
...
real(blas77_f32), intent(inout) :: tauq2(*)
