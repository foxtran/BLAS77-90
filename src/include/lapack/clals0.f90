pure subroutine clals0(icompq,nl,nr,sqre,nrhs,b,ldb,bx,ldbx,perm,givptr,givcol, &
    ldgcol,givnum,ldgnum,poles,difl,difr,z,k,c,s,rwork, &
    info) BEGCNAME(clals0,SUFFIX)
