pure subroutine zggsvp3(jobu,jobv,jobq,m,p,n,a,lda,b,ldb,tola,tolb,k,l,u,ldu,v,ldv,q,ldq,iwork,rwork,tau,work,lwork,info) BEGCNAME(zggsvp3,SUFFIX)
ENDCNAME(zggsvp3,SUFFIX)
import
