pure subroutine dstemr(jobz,range,n,d,e,vl,vu,il,iu,m,w,z,ldz,nzc,isuppz,tryrac,work,lwork,iwork,liwork,info) BEGCNAME(dstemr,SUFFIX)
ENDCNAME(dstemr,SUFFIX)
import
