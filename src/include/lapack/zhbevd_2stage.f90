pure subroutine zhbevd_2stage(jobz,uplo,n,kd,ab,ldab,w,z,ldz,work,lwork,rwork,lrwork,iwork,liwork,info) BEGCNAME(zhbevd_2stage,SUFFIX)
ENDCNAME(zhbevd_2stage,SUFFIX)
import
