pure subroutine dpbsvx(fact,uplo,n,kd,nrhs,ab,ldab,afb,ldafb,equed,s,b,ldb,x,ldx,rcond,ferr,berr,work,iwork,info) BEGCNAME(dpbsvx,SUFFIX)
ENDCNAME(dpbsvx,SUFFIX)
import
