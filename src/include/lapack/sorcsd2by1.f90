pure subroutine sorcsd2by1(jobu1,jobu2,jobv1t,m,p,q,x11,ldx11,x21,ldx21,theta,u1,ldu1,u2,ldu2,v1t,ldv1t,work,lwork,iwork,info) BEGCNAME(sorcsd2by1,SUFFIX)
ENDCNAME(sorcsd2by1,SUFFIX)
import
