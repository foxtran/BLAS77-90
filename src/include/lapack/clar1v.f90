pure subroutine clar1v(n,b1,bn,lambda,d,l,ld,lld,pivmin,gaptol,z,wantnc,negcnt,ztz,mingma,r,isuppz,nrminv,resid,rqcorr,work) BEGCNAME(clar1v,SUFFIX)
ENDCNAME(clar1v,SUFFIX)
import
