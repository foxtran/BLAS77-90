pure subroutine cgesvdq(joba,jobp,jobr,jobu,jobv,m,n,a,lda,s,u,ldu,v,ldv, &
    numrank,iwork,liwork,cwork,lcwork,rwork,lrwork, &
    info) BEGCNAME(cgesvdq,SUFFIX)
...
complex(blas77_f32), intent(inout) :: cwork(*)
